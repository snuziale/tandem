      ...
      <div className="w-full max-w-md space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1.5">
            Reviews post as <em>you</em>, so Tandem needs a personal access
            token with repo read and pull-request write. It stays on this
            machine — written to{" "}
            <code className="font-mono text-[11px]">{status.configPath}</code>{" "}
            and used server-side only.
          </p>
        </div>
