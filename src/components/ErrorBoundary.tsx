      ...
      <div className="flex-1 min-h-screen flex items-center justify-center p-6">
        <Card className="max-w-lg w-full p-6 gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">The app hit an unexpected error. Reloading usually fixes it.</p>
          </div>
          ...
          <pre className="font-mono text-xs text-muted-foreground whitespace-pre-wrap break-words">{truncated}</pre>
        </Card>
      </div>
    );
  }
