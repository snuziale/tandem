...
type DetailResponse = {
  repository: { pullRequest: (GqlPrNode & { reviewThreads: { totalCount: number; nodes: GqlReviewThread[] } }) | null } | null;
};

export async function fetchPrDetail(cfg: Config, ref: PrRef, signal?: AbortSignal): Promise<PrDetail | null> {
